...
{
    QGLWidget* widget = reinterpret_cast<QGLWidget*>(user_data);
    widget->update();
}
...
//    //pipeline2 = gst_parse_launch( "videotestsrc ! qwidget5videosink name=videosink", &err );
    ...
    pipeline1 = gst_parse_launch( "videotestsrc ! qt5glvideosink name=videosink", &err );
    pipeline2 = gst_parse_launch( "videotestsrc ! qt5glvideosink name=videosink", &err );
...
{
    QGLWidget* in = reinterpret_cast<QGLWidget*>(o);
